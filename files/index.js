...
const UUID = process.env.UUID || '277cc408-95e1-40f2-9caf-caa739702269'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'chusb.air.now.cc';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiOGY2ZmZiODM1MzVmYmQ2Yjg5M2Y5ODY3NjJmZjQwMjQiLCJ0IjoiOWMwYzljMWYtMmEzZC00MTM4LWIyZGEtYTI4YTM2MWQzNDBlIiwicyI6Ik5EZ3pZakl5TnpFdFkySTNNeTAwTVdJMExUaGpOR0l0TW1NNFptSm1PVFUzWVRoaCJ9';
